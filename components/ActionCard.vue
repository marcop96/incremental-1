...
<template>
  <div
    ...
    :class="{
      ...
      'bg-gray-300': skillStore.activeSkill?.isGathering===false && !userHasItem, // Adding a conditional class for `userHasItem`
    }"
  >
    ...
    <div class="w-full h-2 bg-gray-300 rounded-full mb-4">
      <div
        ...
        :class="{ 'bg-green-500': props.activeResource && (props.activeResource as Resource).name === props.resource.name }"
      />
    </div>
    <div class="text-sm font-medium text-gray-600">
      ...
      <span
        :class="{
          'text-green-500': props.activeResource && (props.activeResource as Resource).name === props.resource.name,
        }"
